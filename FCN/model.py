...
class FCN8(nn.Module):
    ...
    def copy_parameters(self, vgg16):
        ...
        for i in range(len(features)):
            if(isinstance(features[i], nn.Conv2d) and isinstance(vgg_features[i], nn.Conv2d)):
                features[i].weight.data.copy_(vgg_features[i].weight.data)
                features[i].bias.data.copy_(vgg_features[i].bias.data)
